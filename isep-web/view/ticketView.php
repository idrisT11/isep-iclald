        ...
        <main>
            ...
            <section id="content">
                <div id="content_header">
                    <h1 id="title_content">
                        La liste des tickets que vous avez emis :
                    </h1>

                    <a href="./ticket/new" id="configure_link" style="font-weight: bold;">
                        Nouveau Ticket
                    </a>
                ...
                <div id="forum_screen">
                    ...
                    ?>
                        <div id="inactive">
                            ...
                            <br>
                            <br>
                            Vous n'avez poster aucun ticket pour le moment.
                            ...
                            <div class="main_part">
                                ...
                                <div >
                                    <div class="result_body">
                                        <?= html_entity_decode($ticket['CONTENU']) ?>
                                    </div>
